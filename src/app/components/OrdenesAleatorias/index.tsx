...
const states: IOrder["state"][] = ["Creados", "Pendientes", "Preparados", "En camino", "Entregado", "Cancelado"];
const paymentMethods: IOrder["paymentMethod"][] = ["Efectivo", "Tarjeta"];
...
const ordenesAleatorias: IOrder[] = Array.from({ length: 100 }, (_, i) => ({
  id: (i + 1).toString(),
