                            ...
                            <TableBody>
                                {ingredients.map((ingredient) => (
                                    <TableRow key={ingredient.id}>
                                        ...
                                        <TableCell>{new Date(ingredient.updatedAt).toLocaleDateString('es-ES', { day: 'numeric', month: 'short' }).replace(/ (\w+)/, (match, month) => ' ' + month.charAt(0).toUpperCase() + month.slice(1))}</TableCell>
                                        <TableCell>
                                            <div className="flex justify-center space-x-1">
                                                <Button size="sm" variant="light" onPress={() => handleEdit(ingredient)}>
                                                ...
                                                <Button size="sm" variant="light" color="danger" onPress={() => handleDelete(ingredient)}>
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">
