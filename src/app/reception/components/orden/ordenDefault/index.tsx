        ...
        <div className="flex flex-col items-center justify-center text-center font-poppins text-primary">
            ...
            <div className="flex flex-col">
                <div className="flex items-center justify-center space-x-4">
                    <h1 className="text-5xl font-black">{currentTime}</h1>
                    <svg width="150" height="150" className="w-[4rem] h-full" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
